...
<div class="p-4 border-b border-gray-200">
    <h2 class="text-xl font-bold text-[#128AD4]">Talk915 Account</h2>
</div>
    ...
    <table class="w-full">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Josh Daniel Collins</td>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Nidal Kendrick</td>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">456-123-789</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Kageyam Lazola</td>
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">321-654-987</td>
